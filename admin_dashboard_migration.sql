...
DECLARE
    ...
    table_name TEXT;
BEGIN
    -- Clean up orphaned tournament registrations
    ...
    -- Clean up orphaned match invites
...
BEGIN
    ...
    -- Check for orphaned match invites
    SELECT COUNT(*) INTO orphaned_count
...
-- Create RLS policies
CREATE POLICY "System settings are viewable by admins" ON public.system_settings
    FOR SELECT USING (
        EXISTS (
