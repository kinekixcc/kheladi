...
-- Test the setup by inserting a sample message (optional)
-- INSERT INTO public.chat_messages (tournament_id, sender_id, message, message_type)
-- VALUES (
--     (SELECT id FROM public.tournaments LIMIT 1),
--     (SELECT id FROM public.profiles LIMIT 1),
--     'Welcome to the tournament chat!',
--     'system'
-- );
